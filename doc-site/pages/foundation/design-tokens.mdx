...
<Layout header={<PageHeader title='Design Tokens' description="Design tokens are the smallest design system atoms. They are named entities that store visual design attributes, and are crucial to keeping designs consistent. They are used in place of hardcoded values, such as HEX color codes for color or pixel values for spacing." />}>
