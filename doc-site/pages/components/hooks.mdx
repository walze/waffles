...
A lot of accessibility-related features rely heavily on element IDs. Manually providing such IDs is both cumbersome and error-prone. To aid with that, the hook autogenerates a **random ID** with optional prefix.
