...
<Layout title="Menu" description="🚧 This page is under construction">
...
In addition to all custom props listed below, `Menu.Button` accepts all props regular `HTMLButton` would, such as `onClick`, `disabled`, and `data-` attributes.

<PropsTable
  metadata={require('!!extract-react-types-loader!../../../src/menu/button')}
  isPolymorphic
/>
