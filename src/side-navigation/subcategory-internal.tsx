...
type SubcategoryBaseProps = {
  ...
  /* An icon displayed to the left. Could be any [icon](/components/icon) from Waffles or a custom component. Depending on the size use default or `xsmall` icon. */
  iconLeft?: JSX.Element;
  /* An icon displayed to the right. Could be any [icon](/components/icon) from Waffles or a custom component. Depending on the size use default or `xsmall` icon. */
  iconRight?: JSX.Element;
  /* Defines the size of the subcategory header element. In most cases, the default size should be used. */
  /* @default medium */
  size?: 'small' | 'medium';
...
function Subcategory<T extends React.ElementType = 'div'>(
  ...
  const subcategoryId = `side-navigation-subcategory-${useId()}`;
