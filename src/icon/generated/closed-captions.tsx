...
type ClosedCaptionsProps = Omit<React.ComponentProps<typeof Icon>, 'children'>;

function ClosedCaptions({ size, ...restProps }: ClosedCaptionsProps) {
  return (
