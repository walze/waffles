...
type IntegrationProps = Omit<React.ComponentProps<typeof Icon>, 'children'>;

function Integration({ size, ...restProps }: IntegrationProps) {
  return (
